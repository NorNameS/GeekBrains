...
public class AppMain4Game {
    ...
    public static void aiTurn() {
        int x , y , riser = 0, max = 0, maxY = 0, maxX = 0;
        ...
        for (int i = 0; i < SIZE; i++)
        {
            for (int j = 0; j < SIZE; j++)
            {
                if(map[i][j] == DOT_X)
                {
                    ...
                    if(j <= (SIZE - DOT_TO_WINS) && i <= (SIZE - DOT_TO_WINS) )
                    {
                        for (int k = 0; k < DOT_TO_WINS; k++)
                        {
                    ...
                    //по диагонали налево
                    if(j >= DOT_TO_WINS - 1 && i >= DOT_TO_WINS - 1 )
                    {
                        for (int k = 0; k < DOT_TO_WINS; k++)
                        {
                            if (map[i - k][j - k] == DOT_X)
                    ...
                    if(j <= SIZE - DOT_TO_WINS + 1 && i >= DOT_TO_WINS - 1)
                    {
                        for (int k = 0; k < DOT_TO_WINS; k++)
                        {
                            if (map[i - k][j + k] == DOT_X)
                    ...
                    //по диагонали сверху налево
                    if(j >= DOT_TO_WINS - 1 && i <= SIZE - DOT_TO_WINS)
                    {
                        for (int k = 0; k < DOT_TO_WINS; k++)
                        {
                            if (map[i + k][j - k] == DOT_X)
                    ...
                    if(j <= (SIZE - DOT_TO_WINS) )
                    {
                        for (int k = j; k < j + DOT_TO_WINS; k++)
                        {
                            if (map[i][k] == DOT_X)
                            {
                                ++riser;
